...
unsigned long long generic_file_write_iter_time, generic_file_write_iter_count;
...
again:
		...
		getrawmonotonic(&myclock[1]);
        	calclock(myclock, &generic_file_write_iter_time, &generic_file_write_iter_count);
